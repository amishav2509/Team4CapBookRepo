...
public class CapBookControllerTest {
	...
	String exampleUserJson = "{\"emailID\":\"ap@gmail.com\",\"firstName\":\"Aparajita \",\"lastName\":\"Singh\",\"password\":\"1234\",\"gender\":\"female\",\"dob\":\"28-09-1995\"}";
	...
	public void getUserDetails() throws Exception {
		...
		String expected = "{emailID:ap@gmail.com,firstName:Aparajita,lastName:Singh,password:1234,gender:female,dob:28-09-1995}";
